/**
 * Production-Safe Responsive HTML Email Template for Account Verification
 * Gmail, Outlook, Apple Mail, and Mobile Compatible.
 * Table-based layout with inline styles and plain text fallback.
 */
...
export function renderVerificationEmail({ to, name, confirmationUrl, appName = 'Niyantran AI' }) {
  const currentYear = new Date().getFullYear();
  const displayName = name ? escapeHtml(name.trim()) : escapeHtml(to.split('@')[0]);
  const safeUrl = confirmationUrl;
...
<head>
  ...
  <title>Verify your email address - ${escapeHtml(appName)}</title>
  <style type="text/css">
...
<body style="margin: 0; padding: 0; background-color: #0b1120; color: #f8fafc;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="560" class="email-container" style="max-width: 560px; width: 100%;">
              ...
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center">
                    ...
                    <div style="font-size: 11px; letter-spacing: 1.5px; color: #64748b; text-transform: uppercase; margin-top: 4px;">Strategic Intelligence &amp; Terminal Systems</div>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td class="email-card" style="background-color: #131d33; border: 1px solid #1e293b; border-radius: 12px; padding: 36px 32px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.5);">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                  <td style="color: #cbd5e1; font-size: 15px; line-height: 1.6; padding-bottom: 20px;">
                    Welcome, <strong>${displayName}</strong>!
                  </td>
                </tr>
                <tr>
                  <td style="color: #94a3b8; font-size: 14px; line-height: 1.6; padding-bottom: 28px;">
                    Thanks for signing up for ${escapeHtml(appName)}. Please confirm your email address by clicking the button below to complete your account setup and activate your desk access.
                  </td>
                </tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" style="border-radius: 8px; background-color: #0284c7;">
                          <a href="${safeUrl}" target="_blank" class="btn" style="font-size: 15px; font-weight: 600; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 8px; display: inline-block; background-color: #0284c7; border: 1px solid #0284c7;">
                ...
                <tr>
                  <td style="color: #64748b; font-size: 12px; line-height: 1.6; border-top: 1px solid #1e293b; padding-top: 20px;">
          ...
          <tr>
            <td align="center" style="padding-top: 28px; color: #475569; font-size: 12px; line-height: 1.6;">
              <p style="margin: 0 0 6px 0;">If you did not create an account, you can safely ignore this email.</p>
  ...
  const text = `Verify your email address - ${appName}

Welcome, ${displayName}!

Thanks for signing up for ${appName}. Please confirm your email address by visiting the link below to complete your account setup:
