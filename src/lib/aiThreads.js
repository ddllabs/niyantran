...
export const captureConversationContext = onServer ? server.captureConversationContext : () => null;
export const adoptConversation = onServer ? server.adoptConversation : () => legacy.loadAiState();
